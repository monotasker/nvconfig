...
-- Removed: <leader>d -> vim.diagnostic.open_float
-- It collided with the entire <leader>d... dap namespace; use <leader>xd
-- (Trouble document diagnostics) or [d / ]d to navigate diagnostics instead.
